...
namespace HotelBookingPlatform.API.Controllers
{
    ...
    [Route("api/hotels")]
    [ApiController]
    public class HotelController(IService<HotelEntity, Hotel> hotelService, IMapper mapper, ILogger logger) : ControllerBase
    {
        /// <summary>
        ...
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] HotelUpdateDto hotelUpdateDto)
        {
            ...
            var isUpdated = await hotelService.Update(id, hotelEntity);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var isDeleted = await hotelService.Delete(id);
            if (!isDeleted)
            {
