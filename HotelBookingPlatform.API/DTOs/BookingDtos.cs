namespace HotelBookingPlatform.API.DTOs
{
    ...
    public record BookingReadDto(int BookingId, int UserId, DateOnly CheckInDate, DateOnly CheckOutDate, decimal TotalPrice,
        string Status, IEnumerable<RoomReadDto> Rooms, DateTime CreationDate, DateTime? ModificationDate);
}
