...
{
    public class HotelRepository(AppDbContext context, ILogger<HotelRepository> logger) : Repository<Hotel>(context, logger), IHotelRepository
    {
        public async Task<IEnumerable<Hotel>> SearchByAmenitiesAsync(string amenities)
        {
            logger.LogInformation("Search hotels by amenity.");
        ...
        {
            logger.LogInformation("Search hotels by city.");
        ...
        {
            logger.LogInformation("Search hotels by rating.");
